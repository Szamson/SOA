package pl.lab.soa.client;

import org.jboss.resteasy.client.jaxrs.ResteasyClient;
import org.jboss.resteasy.client.jaxrs.ResteasyClientBuilder;
import org.jboss.resteasy.client.jaxrs.ResteasyWebTarget;
import org.jboss.resteasy.specimpl.MultivaluedMapImpl;
import pl.lab.soa.model.Student;
import pl.lab.soa.model.StudentProto;
import pl.lab.soa.protobuf.StudentMessageWriter;
...
public class RESTClient {
    ...
    public void authorize() {
        ResteasyWebTarget target = resteasyClient.target("http://localhost:8080/lab1final-web/api/auth/login");
        Form form = new Form();
    ...
    private List<Student> getAllStudents(MultivaluedMap<String, Object> parameters) {
        ...
        ResteasyWebTarget target = resteasyClient.target("http://localhost:8080/lab1final-web/api/students/");
    ...
    private Student getStudentById(int id){
        Student result = null;
        ResteasyWebTarget target = resteasyClient.target("http://localhost:8080/lab1final-web/api/students/"+id);
    ...
    private StudentProto.Student getStudentByIdProto(int id){
        ...
        ResteasyWebTarget target = resteasyClient.target("http://localhost:8080/lab1final-web/api/students/"+id+"/protobuf").register(StudentMessageWriter.class);
    ...
    private void displayAvatar(int id){
        byte[] result = null;
        ResteasyWebTarget target = resteasyClient.target("http://localhost:8080/lab1final-web/api/students/"+id+"/avatar");
    ...
    public static void main(String[] args) {
        ...
        Student student = new Student("", 6, 17, "C:\\Users\\szymo\\Desktop\\Knight_3.png", courses);
